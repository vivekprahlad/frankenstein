 ...
 */
public class DefaultFrankensteinIntegration implements FrankensteinIntegration {
    ...
    public DefaultFrankensteinIntegration(Class mainClass,
                                          JFrame frame,
    ...
    public DefaultFrankensteinIntegration(Application application,
                                          JFrame frame,
                                          WorkerThreadMonitor monitor,
                                          WindowContext context,
                                          NamingStrategy namingStrategy,
    ...
    public DefaultFrankensteinIntegration(Class mainClass, WorkerThreadMonitor monitor) {
    ...
    public DefaultFrankensteinIntegration(Application application, JFrame frame, WorkerThreadMonitor monitor, WindowContext context, NamingStrategy namingStrategy) {
